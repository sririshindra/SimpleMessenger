        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            while(true) {
                try {
                    ...
                    Log.i(TAG, "entered line 170 ");

                    String line = br.readLine();
                    if (line != null) {
                        Log.i(TAG, "entered line 174 " + line.toString());
                        publishProgress(line);
                    }


                } catch (IOException ie) {
                    Log.e(TAG, "ServerTask socket IOException " + ie.getMessage());
                    break;
                } catch (Exception e){
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                Log.i(TAG, "sending the message " + msgToSend);
                dOut.println(msgToSend);
